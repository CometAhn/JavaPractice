...
public class Continue {
	...
	public static void main(String[] args) {
		 ...
		 */
		/*
		 * int money = 10000; System.out.println("현재가진돈은 "+money+"입니다."); // 현재 가진돈은
		 * 10000
		 * 
		 ...
		 * System.out.println("다시 입력해주세요(사용범위가 틀렸습니다.)"); continue; // while로 돌아감. }
		 * 
		 * System.out.printf("이제 %d원이 남았습니다. \n", money -= i); // money - i 프린트 if(money
		 * == 0) { // money가 0이 될 경우 조건문에서 나간다. break; } }
